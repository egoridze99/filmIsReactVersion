      ...
      <div className="fivth-section__wrapper">
        ...
        <div className="fivth-section__text-block">
          ...
          <p className="text-block__text" data-scrolly-down="fadeIn">
            В нашем кинотеатре предоставлена услуга караоке. Вы можете выбрать
            любую из 100 тысяч песен имеющихся в каталоге.
          </p>
          <p className="text-block__text" data-scrolly-down="fadeIn">
            <span className="item__sum">Цена: </span>Аренда зала + 500 рублей
            (За компанию)
          </p>
        </div>
      </div>
